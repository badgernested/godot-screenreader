...
const BUTTON_STYLES = {
	"default" : preload("res://addons/godot-screenreader/ui/img/default/x_box.png"),
	"hc_dark" : preload("res://addons/godot-screenreader/ui/img/dark/x_box.png"),
	"hc_light" : preload("res://addons/godot-screenreader/ui/img/light/x_box.png")
}
