...
const _SFX_LIBRARY: Dictionary = {
	"button_down" : preload("res://addons/godot-screenreader/sfx/button_down.wav"),
	"button_up" : preload("res://addons/godot-screenreader/sfx/button_up.wav"),
	"text_enter" : preload("res://addons/godot-screenreader/sfx/text_enter.wav"),
	"text_newline" : preload("res://addons/godot-screenreader/sfx/text_newline.wav"),
	"tab_nav" : preload("res://addons/godot-screenreader/sfx/tab_nav.wav"),
	"slider" : preload("res://addons/godot-screenreader/sfx/slider_change.wav"),
	"slider_move" : preload("res://addons/godot-screenreader/sfx/slider_move.wav"),
	"tree_collapse" : preload("res://addons/godot-screenreader/sfx/tree_collapse.wav"),
	"tree_uncollapse" : preload("res://addons/godot-screenreader/sfx/tree_uncollapse.wav"),
	"tree_enter" : preload("res://addons/godot-screenreader/sfx/tree_enter.wav"),
	"tree_exit" : preload("res://addons/godot-screenreader/sfx/tree_exit.wav"),
	"tree_no_children" : preload("res://addons/godot-screenreader/sfx/tree_no_children.wav"),
	"list_nav" : preload("res://addons/godot-screenreader/sfx/list_nav.wav"),
	"menu_open" : preload("res://addons/godot-screenreader/sfx/menu_open.wav"),
	"menu_close" : preload("res://addons/godot-screenreader/sfx/menu_close.wav"),
	"node_select" : preload("res://addons/godot-screenreader/sfx/node_selector.wav"),
	"node_select_exit" : preload("res://addons/godot-screenreader/sfx/node_select_exit.wav")
}
