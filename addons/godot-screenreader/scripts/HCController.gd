...
const _FOCUS_STYLE = {
	"default" : preload("res://addons/godot-screenreader/ui/style/focus_end_node.tres"),
	"hc_dark" : preload("res://addons/godot-screenreader/ui/style/focus_end_node_hc_dark.tres"),
	"hc_light" : preload("res://addons/godot-screenreader/ui/style/focus_end_node_hc_dark.tres")
}

# This is the style 
const _STYLES = {
	"hc_dark" : preload("res://addons/godot-screenreader/ui/style/HiContrast_Dark.tres"),
	"hc_light" : preload("res://addons/godot-screenreader/ui/style/HiContrast_Light.tres")
}

# This is the gradient for the top borders of accessibility menus
const _GRADIENT_STYLES = {
	"hc_dark" : preload("res://addons/godot-screenreader/ui/gradient/DarkMode.tres"),
	"hc_light" : preload("res://addons/godot-screenreader/ui/gradient/LightMode.tres"),
	"default" : preload("res://addons/godot-screenreader/ui/gradient/AccessDefault.tres")
}
