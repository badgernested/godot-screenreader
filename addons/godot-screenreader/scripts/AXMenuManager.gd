...
const _MENUS = {
	"tutorial" : preload("res://addons/godot-screenreader/menu/ax/Tutorial.tscn"),
	"main" : preload("res://addons/godot-screenreader/menu/ax/AxMenu.tscn"),
	"node_select" : preload("res://addons/godot-screenreader/menu/ax/NodeSelector.tscn"),
	"screenreader_options" : preload("res://addons/godot-screenreader/menu/ax/ScreenreaderOptions.tscn"),
	"options" : preload("res://addons/godot-screenreader/menu/ax/Options.tscn"),
}
