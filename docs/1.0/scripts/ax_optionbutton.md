# ax_optionbutton
Inherits: [OptionButton](https://docs.godotengine.org/en/stable/classes/class_optionbutton.html)

Script for adding additional accessibility function to OptionButton Controls.

## Description

This script is designed to extend functionality for the OptionButton Control to godot-screenreader. Extend this script to add additional functionality such as custom screenreader text and input.
