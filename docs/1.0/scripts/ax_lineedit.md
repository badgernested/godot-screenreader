...
Script for adding additional accessibility function to LineEdit Controls.

## Description

This script is designed to extend functionality for the LineEdit Control to godot-screenreader. Extend this script to add additional functionality such as custom screenreader text and input.
