...
Script for adding additional accessibility function to Button Controls.

## Description

This script is designed to extend functionality for the Button Control to godot-screenreader. Extend this script to add additional functionality such as custom screenreader text and input.
