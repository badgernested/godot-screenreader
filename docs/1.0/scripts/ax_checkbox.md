# ax_checkbox
Inherits: [CheckBox](https://docs.godotengine.org/en/stable/classes/class_checkbox.html)

Script for adding additional accessibility function to Checkbox Controls.

## Description

This script is designed to extend functionality for the Checkbox Control to godot-screenreader. Extend this script to add additional functionality such as custom screenreader text and input.
