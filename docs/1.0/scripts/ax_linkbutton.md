# ax_linkbutton
Inherits: [LinkButton](https://docs.godotengine.org/en/stable/classes/class_linkbutton.html)

Script for adding additional accessibility function to LinkButton Controls.

## Description

This script is designed to extend functionality for the LinkButton Control to godot-screenreader. Extend this script to add additional functionality such as custom screenreader text and input.
