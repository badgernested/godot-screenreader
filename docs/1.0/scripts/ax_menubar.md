# ax_menubar
Inherits: [MenuBar](https://docs.godotengine.org/en/stable/classes/class_menubar.html)

Script for adding additional accessibility function to MenuBar Controls.

## Description

This script is designed to extend functionality for the MenuBar Control to godot-screenreader. Extend this script to add additional functionality such as custom screenreader text and input.
