# ax_textedit
Inherits: [TextEdit](https://docs.godotengine.org/en/stable/classes/class_textedit.html)

Script for adding additional accessibility function to TextEdit Controls.

## Description

This script is designed to extend functionality for the TextEdit Control to godot-screenreader. Extend this script to add additional functionality such as custom screenreader text and input.
