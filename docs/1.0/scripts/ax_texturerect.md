# ax_texturerect
Inherits: [TextureRect](https://docs.godotengine.org/en/stable/classes/class_texturerect.html)

Script for adding additional accessibility function to TextureRect Controls.

## Description

This script is designed to extend functionality for the TextureRect Control to godot-screenreader. Extend this script to add additional functionality such as custom screenreader text and input.
